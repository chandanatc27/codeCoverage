...
public class Main {
	...
	public static void loadInventory() {
		...
		Product p1 = new Product("TOBLERONE");
		Product p2 = new Product("DRY FRUITS");
		Product p3 = new Product("SAMSUNG TV");
		Product p4 = new Product("IPHONE");
		Product p5 = new Product("DELL LAPTOP");
		Product p6 = new Product("TITAN WATCH");
	...
	public static void runTransactions() {
		...
		pickResult = inventoryWarehouse.pickProduct("CALENDULA SOAP", 5);
		System.out.println(pickResult.getMessage());
